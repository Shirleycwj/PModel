...
for (f in 1:420) {
  ...
  my_Rad <- read.csv(paste("/Volumes/兔子/研究生学习/Projects/20180620_global/Data/ppfd/map_convert_unit/",fn[r],sep = ""),header = F)
  my_ppfd <- my_Rad * kfFEC * (1.0e-3);
  
  my_tc <- read.csv(paste("/Volumes/兔子/研究生学习/Projects/20180620_global/Data/Tmp/convert_map/",fn[r],sep = ""),header = F)
  my_Tmax <- read.csv(paste("/Volumes/兔子/研究生学习/Projects/20180620_global/Data/Tmx/convert_map/",fn[r],sep = ""),header = F)
  my_Tmin <- read.csv(paste("/Volumes/兔子/研究生学习/Projects/20180620_global/Data/Tmn/convert_map/",fn[r],sep = ""),header = F)
  my_vap <- read.csv(paste("/Volumes/兔子/研究生学习/Projects/20180620_global/Data/Vap/convert_map/",fn[r],sep = ""),header = F)
  ...
  out_file <- paste("/Users/wenjia/Desktop/PhD/Research/sensitivity_GPP/GPP_VPD/mon_cli_gpp/",fn[f],sep = "")
