rm(list =ls())
setwd("/Users/wenjia/Desktop/PhD/20190415_C4/Global/annual_gpp")
fn <- dir()
...
# write.csv(bio_gpp,"/Users/shirley/Desktop/REALM/C4_2:3/Global_2:3_20190318/single_trend/Tc/gpp_global_modi_tc.csv",row.names = F)
