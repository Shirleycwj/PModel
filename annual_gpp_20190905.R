rm(list = ls());
setwd("/Users/wenjia/Desktop/PhD/20190415_C4/Global/mon_gpp")
fn <- dir()

for (f in seq(from=1,to=409,by=12)) {
  path <- "/Users/wenjia/Desktop/PhD/20190415_C4/Global/mon_gpp"
  fileNames <- fn[f:(f+11)]
  ##生成读取文件路径
  ...
  out_file <- paste("/Users/wenjia/Desktop/PhD/20190415_C4/Global/annual_gpp/",substr(fn[f],1,4),".csv",sep = "")
