...
#C3_phi0 = 0.080 * c_molmass # # mol/mol From Skillman 2008 & Long et al. 1993 # gC/mol Intrinisic quantum yield of photosynthesis for C3 plants
# C3_phi0 updated on 20180516 after calibration
#C4_phi0 = 0.055 * c_molmass # # mol/mol From Skillman 2008 & Long et al. 1993 # gC/mol Intrinisic quantum yield of photosynthesis for C4 plants
